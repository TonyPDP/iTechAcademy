    ...
    <div>
      ...
      <div className="flex my-[32px] gap-[14px]">
        ...
        <div className="flex gap-[14px]">
          <button className="flex items-center border border-gray-300 rounded-md text-[20px] font-semibold px-[19px] py-[9.5px] gap-[11px] bg-[#EDEDED]">
            <ArrowUpDown size={18} className="rotate-90" />
            Filters
          </button>
          <button className="flex items-center border border-gray-300 rounded-md text-[20px] font-semibold px-[19px] py-[9.5px] bg-[#EDEDED]">
            <Calendar size={18} />
            Date
          </button>
        </div>
      ...
      <div>
        <table className="w-full">
          <thead className="text-left">
            <tr>
              {["Name", "Course", "Mentor", "Members", "Status", "Actions"].map(
                (heading) => (
                  <th
                    key={heading}
