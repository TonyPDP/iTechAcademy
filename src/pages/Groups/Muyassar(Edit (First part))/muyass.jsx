    ...
    <div className="p-6">
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSave}>
        <div>
          ...
          <input className="w-full border px-4 py-2 rounded" defaultValue="Python Beginners Batch A" />
        </div>
        <div>
        ...
        <div>
          ...
          <input className="w-full border px-4 py-2 rounded" defaultValue="Jaloliddin Anorboyev" />
        </div>
        <div>
        ...
        <div>
          ...
          <input className="w-full border px-4 py-2 rounded" defaultValue="9:00 AM - 10:30 AM" />
        </div>
        <div>
          <label className="block mb-1 font-semibold">Price*</label>
          <input className="w-full border px-4 py-2 rounded" defaultValue="$500" />
        </div>
        <div>
          <label className="block mb-1 font-semibold">Classroom*</label>
          <input className="w-full border px-4 py-2 rounded" defaultValue="Room 101" />
        </div>
        <div>
          <label className="block mb-1 font-semibold">Start Date*</label>
          <input className="w-full border px-4 py-2 rounded" defaultValue="Narch 22, 2025" />
        </div>
